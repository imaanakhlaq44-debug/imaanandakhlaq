...
let currentPage = 55;
// Distribute 36 pages across remaining 6 chapters (Chapter 10 to 15) -> exactly 6 pages each
for (let i = 10; i <= 15; i++) {
...
console.log('Successfully updated Book 2 chapters with Ch 9 ending at 54');
