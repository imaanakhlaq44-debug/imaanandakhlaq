...
let currentPage = 31;
// Distribute 60 pages across remaining 10 chapters (Chapter 6 to 15) -> exactly 6 pages each
for (let i = 6; i <= 15; i++) {
  let pagesForThisChapter = 6; 
  if (i === 15) {
     pagesForThisChapter = 90 - currentPage + 1; // Just in case, should be 6
  }
...
console.log('Successfully updated Book 2 chapters with Ch 5 ending at 30');
