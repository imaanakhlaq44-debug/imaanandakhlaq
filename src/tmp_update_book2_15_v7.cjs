...
let currentPage = 60;
// Distribute 31 pages across remaining 5 chapters (Chapter 11 to 15)
for (let i = 11; i <= 15; i++) {
  let pagesForThisChapter = (i <= 14) ? 6 : 7; // 4 chapters get 6, 1 gets 7
  if (i === 15) {
...
console.log('Successfully updated Book 2 chapters with Ch 10 ending at 59');
