...
let currentPage = 75;
// Distribute 16 pages across remaining 3 chapters (Chapter 13 to 15)
for (let i = 13; i <= 15; i++) {
  let pagesForThisChapter = (i === 15) ? 6 : 5; // First two get 5 pages, last chapter gets 6
  if (i === 15) {
...
console.log('Successfully updated Book 2 chapters with Ch 12 ending at 74');
