...
let currentPage = 20;
// Distribute 71 pages across remaining 12 chapters (Chapter 4 to 15)
for (let i = 4; i <= 15; i++) {
  let pagesForThisChapter = (i <= 14) ? 6 : 5; // 11 chapters with 6 pages, 1 chapter with 5
  if (i === 15) {
...
console.log('Successfully updated Book 2 chapters with Ch 3 ending at 19');
