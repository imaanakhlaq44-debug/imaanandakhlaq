...
let currentPage = 81;
// Distribute 10 pages across remaining 2 chapters (Chapter 14 and 15) -> exactly 5 pages each!
for (let i = 14; i <= 15; i++) {
  let pagesForThisChapter = 5; 
  if (i === 15) {
...
console.log('Successfully updated Book 2 chapters with Ch 13 ending at 80');
