        ...
        <div class="link-copy">
          ...
          <div class="link-meta">
            <div class="link-form-shell">
              <input type="text" id="parentStudentCodeInput" class="parent-text-input text-center" placeholder="e.g. STU-XXXXX" style="font-family: 'JetBrains Mono', monospace; font-size: 1.05rem; text-transform: uppercase;">
