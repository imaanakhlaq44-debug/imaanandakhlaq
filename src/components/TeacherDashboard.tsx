...
<script type="module">
  ...
  // What one press of the hardware Back button means here, for the APK
  // shell (scripts/apk-shell.cjs): a section other than the overview goes
  // back to the overview. On the overview the shell takes over — press
