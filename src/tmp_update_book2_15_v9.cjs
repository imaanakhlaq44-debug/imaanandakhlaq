...
let currentPage = 67;
// Distribute 24 pages across remaining 4 chapters (Chapter 12 to 15) -> exactly 6 pages each
for (let i = 12; i <= 15; i++) {
...
console.log('Successfully updated Book 2 chapters with Ch 11 ending at 66');
