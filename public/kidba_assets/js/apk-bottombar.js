...
(function () {
  ...
  var BUTTONS = [{
    ...
    label: 'Qibla',
    href: 'apk/qibla.html',
    svg: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">' + '<defs><linearGradient id="gQ" x1="0" x2="0" y1="0" y2="1"><stop offset="0%" stop-color="#E85B98"/><stop offset="100%" stop-color="#B62E66"/></linearGradient></defs>' + '<path fill="url(#gQ)" d="M16 2C10 2 6 6.3 6 12c0 6.5 6.6 13.7 9.2 16.4a1.1 1.1 0 0 0 1.6 0C19.4 25.7 26 18.5 26 12 26 6.3 22 2 16 2z"/>' + '<circle cx="16" cy="12" r="4" fill="#fff"/>' + '<rect x="13" y="10" width="6" height="4" rx="0.5" fill="#1E2D5A"/>' + '<rect x="13" y="11" width="6" height="1" fill="#E0B341"/>' + '</svg>'
  }, {
    key: 'tasbeeh',
    label: 'Tasbeeh',
    href: 'apk/tasbeeh.html',
    svg: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">' + '<defs><radialGradient id="gT" cx="30%" cy="30%" r="70%"><stop offset="0%" stop-color="#FBC07A"/><stop offset="100%" stop-color="#B85A0F"/></radialGradient></defs>' + '<circle cx="16" cy="6"  r="3" fill="url(#gT)"/>' + '<circle cx="9"  cy="10" r="2.5" fill="url(#gT)"/>' + '<circle cx="23" cy="10" r="2.5" fill="url(#gT)"/>' + '<circle cx="5"  cy="16" r="2.3" fill="url(#gT)"/>' + '<circle cx="27" cy="16" r="2.3" fill="url(#gT)"/>' + '<circle cx="7"  cy="22" r="2.3" fill="url(#gT)"/>' + '<circle cx="25" cy="22" r="2.3" fill="url(#gT)"/>' + '<circle cx="12" cy="26" r="2.3" fill="url(#gT)"/>' + '<circle cx="20" cy="26" r="2.3" fill="url(#gT)"/>' + '<path d="M16 6 C9 10 5 16 7 22 C12 26 20 26 25 22 C27 16 23 10 16 6" fill="none" stroke="#1E2D5A" stroke-width="0.6" opacity="0.4"/>' + '</svg>'
  }, {
    key: 'faqs',
    label: 'FAQs',
    href: 'apk/faqs.html',
    svg: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">' + '<defs><linearGradient id="gF" x1="0" x2="0" y1="0" y2="1"><stop offset="0%" stop-color="#5A9CFF"/><stop offset="100%" stop-color="#2256C6"/></linearGradient></defs>' + '<path fill="url(#gF)" d="M5 6a3 3 0 0 1 3-3h16a3 3 0 0 1 3 3v14a3 3 0 0 1-3 3H13l-6 5v-5H8a3 3 0 0 1-3-3V6z"/>' + '<text x="16" y="18" font-family="Nunito,Arial" font-size="12" font-weight="800" fill="#fff" text-anchor="middle">?</text>' + '</svg>'
  }, {
    key: 'about',
    label: 'About',
    href: 'apk/about.html',
    svg: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">' + '<defs><linearGradient id="gA" x1="0" x2="0" y1="0" y2="1"><stop offset="0%" stop-color="#8C7BFF"/><stop offset="100%" stop-color="#3B2EA8"/></linearGradient></defs>' + '<circle cx="16" cy="16" r="13" fill="url(#gA)"/>' + '<circle cx="16" cy="10" r="1.8" fill="#fff"/>' + '<rect x="14.4" y="13" width="3.2" height="10" rx="1.2" fill="#fff"/>' + '</svg>'
  }, {
    key: 'whatsapp',
    label: 'WhatsApp',
    href: 'https://wa.me/' + WA,
    external: true,
    svg: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">' + '<circle cx="16" cy="16" r="15" fill="#25D366"/>' + '<path fill="#FFFFFF" d="M22.94 19.31c-.36-.18-2.13-1.05-2.46-1.17-.33-.12-.57-.18-.81.18-.24.36-.93 1.17-1.14 1.41-.21.24-.42.27-.78.09-.36-.18-1.52-.56-2.89-1.78-1.07-.95-1.79-2.13-2-2.49-.21-.36-.02-.55.16-.73.16-.16.36-.42.54-.63.18-.21.24-.36.36-.6.12-.24.06-.45-.03-.63-.09-.18-.81-1.95-1.11-2.67-.29-.7-.59-.6-.81-.61-.21-.01-.45-.01-.69-.01-.24 0-.63.09-.96.45-.33.36-1.26 1.23-1.26 3 0 1.77 1.29 3.48 1.47 3.72.18.24 2.54 3.88 6.16 5.44.86.37 1.53.59 2.05.76.86.27 1.65.23 2.27.14.69-.1 2.13-.87 2.43-1.71.3-.84.3-1.56.21-1.71-.09-.15-.33-.24-.69-.42z"/>' + '<path fill="#FFFFFF" d="M27 5A14 14 0 0 0 5 22L3 30l8-2A14 14 0 1 0 27 5zM16 27.5a11.5 11.5 0 0 1-5.85-1.6l-.42-.25-4.36 1.14 1.16-4.25-.27-.43A11.5 11.5 0 1 1 16 27.5z"/>' + '</svg>'
  }];
  var bar = document.createElement('div');
  bar.className = 'apk-bottombar';
  bar.innerHTML = '<button type="button" class="apk-bottombar__chev" data-dir="-1" aria-label="Scroll left">&#10094;</button>' + '<div class="apk-bottombar__scroll"></div>' + '<button type="button" class="apk-bottombar__chev" data-dir="1" aria-label="Scroll right">&#10095;</button>';
  ...
  BUTTONS.forEach(function (b) {
    ...
    a.innerHTML = '<span class="apk-bottombar__icon">' + b.svg + '</span>' + '<span class="apk-bottombar__label">' + b.label + '</span>';
  ...
  window.addEventListener('scroll', ensureMounted, {
    passive: true
  });
  ...
  (function setupKeyboardWatch() {
    var _bar = null;
    function getBar() {
      if (!_bar) _bar = document.querySelector('.apk-bottombar');
      return _bar;
    }
    function setKb(open) {
      try {
    ...
    try {
      ...
      function tryCapacitorKb() {
        ...
        if (kb && kb.addListener) {
          kb.addListener('keyboardWillShow', function () {
            setKb(true);
          });
    ...
    document.addEventListener('focusin', function (ev) {
      if (isTextInput(ev.target)) setKb(true);
    }, true);
  ...
  (function setupBackHandler() {
    ...
    function attach(App) {
      ...
      function isHomeLikePage() {
        var p = (location.pathname || '').toLowerCase();
        return p === '/' || p === '' || p.indexOf('/auth') === 0 || p.indexOf('auth.html') !== -1 || p.indexOf('/index.html') !== -1 || p.indexOf('dashboard') !== -1 || p.indexOf('student-activities') !== -1;
      }
