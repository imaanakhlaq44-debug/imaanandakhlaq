...
// 3. Inject daily-chapter (CSS+JS+Amiri font) into parent-dashboard ONLY
console.log('Wiring daily-chapter popup into parent-dashboard.html...');
...
patchHtml('parent-dashboard.html', html => {
